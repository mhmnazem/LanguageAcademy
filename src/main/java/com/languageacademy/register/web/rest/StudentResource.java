...
import com.languageacademy.register.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.languageacademy.register.domain.Student}.
 */
@RestController
@RequestMapping("/api")
public class StudentResource {
    ...
    private static final String ENTITY_NAME = "myLanguageAcademyStudent";
